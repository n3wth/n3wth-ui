...
**Requires**: `NPM_TOKEN` secret in GitHub repo settings (https://github.com/n3wth/n3wth-ui/settings/secrets/actions)

**Manual publish** (if workflow fails or secret not set):
```bash
